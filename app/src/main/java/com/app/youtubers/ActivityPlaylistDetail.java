...
public class ActivityPlaylistDetail extends AppCompatActivity {
    ...
    private void prepareAds() {
        ...
        adNetworkHelper.loadInterstitialAd(AdConfig.ADS_PLAYLIST_DETAILS_INTERSTITIAL);
    }

    public boolean showInterstitialAd() {
        return adNetworkHelper.showInterstitialAd(AdConfig.ADS_PLAYLIST_DETAILS_INTERSTITIAL);
    }
}
