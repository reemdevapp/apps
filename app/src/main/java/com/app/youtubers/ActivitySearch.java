...
import com.app.youtubers.adapter.AdapterSearchVideo;
...
import com.app.youtubers.connection.callback.CallbackSearchVideo;
...
public class ActivitySearch extends AppCompatActivity {
    ...
    private void prepareAds() {
        ...
        adNetworkHelper.loadBannerAd(AdConfig.ADS_SEARCH_PAGE_BANNER);
        adNetworkHelper.loadInterstitialAd(AdConfig.ADS_SEARCH_PAGE_INTERSTITIAL);
    }

    public boolean showInterstitialAd() {
        return adNetworkHelper.showInterstitialAd(AdConfig.ADS_SEARCH_PAGE_INTERSTITIAL);
    }
